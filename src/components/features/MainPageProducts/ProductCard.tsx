...
import { CheckCircle, XCircle, Heart, BarChart2, Share2 } from 'lucide-react';
            ...
            <div>
              {hasDiscount ? (
                <div className="flex flex-col gap-1">
                  <span className="text-sm line-through text-muted-foreground">{format(price)}</span>
                  <span className="text-lg font-semibold text-foreground">{format(discountPrice as number)}</span>
                </div>
              ) : (
